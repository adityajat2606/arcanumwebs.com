          ...
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-[1.2fr_1fr_1fr_1fr_1fr]">
            <div>
              <Link href="/" className="inline-flex items-center gap-3">
                <div className="flex h-11 w-11 items-center justify-center overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-1.5">
                  <img src="/favicon.png?v=20260401" alt={`${SITE_CONFIG.name} logo`} width="44" height="44" className="h-full w-full object-contain" />
                </div>
                <span className="text-lg font-semibold tracking-tight">{SITE_CONFIG.name}</span>
              </Link>
              <p className="mt-5 max-w-sm text-sm leading-7 text-white/55">{SITE_CONFIG.description}</p>
            </div>
            <div>
              <h4 className="text-xs font-semibold uppercase tracking-[0.22em] text-white">Content</h4>
            ...
            <div>
              <h4 className="text-xs font-semibold uppercase tracking-[0.22em] text-white">Resources</h4>
              <ul className="mt-4 space-y-3 text-sm text-white/60">
                {footerLinks.resources.map((item) => (
                  <li key={item.name}>
                    <Link href={item.href} className="transition hover:text-white">
            ...
            <div>
              <h4 className="text-xs font-semibold uppercase tracking-[0.22em] text-white">Company</h4>
              <ul className="mt-4 space-y-3 text-sm text-white/60">
            ...
            <div>
              <h4 className="text-xs font-semibold uppercase tracking-[0.22em] text-white">Legal</h4>
              <ul className="mt-4 space-y-3 text-sm text-white/60">
            ...
            <div className="flex gap-3">
              {socialLinks.map((item) => (
                <Link
                  ...
                  className="rounded-full border border-white/10 p-2.5 text-white/70 transition hover:border-white/25 hover:text-white"
                >
                  <item.icon className="h-4 w-4" />
                </Link>
              ))}
